...
KV.World = class World {
    ...
    buildChunkMesh(chunk) {
        ...
        if (typeof THREE === 'undefined') {
             ...
             chunk.isGeneratingMesh = false; // Release lock if THREE missing
             return;
        }
                    ...
                    for (const face of faceData) {
                        ...
                        if (isNeighborTransparentOrAir(neighborX, neighborY, neighborZ)) {
                            ...
                            if (materialIndex === undefined) {
                                const threeMaterial = KV.getBlockMaterial(materialKey, blockDef); // Uses blocks.js function
        ...
        chunk.isGeneratingMesh = false; // Release lock
         ...
         console.error(`Error building mesh for chunk ${chunk.x},${chunk.y},${chunk.z}:`, error);
         chunk.isGeneratingMesh = false; // Ensure lock is released on error
    }
}
